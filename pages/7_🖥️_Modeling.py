...
Als erstes haben wir Inception V3 genutzt um die Bilder vorzuverarbeiten. Danach haben wir die Bildunterschriften mithilfe des TextVectorization layers in Integer Sequenzen transformiert. Hierbei haben wir eine maximale Länge von 50 Wörtern pro Caption gewählt. Außerdem sind nur die 5.000 häufigsten Wörter aller Bildunterschriften zur Erzeugung erlaubt.
