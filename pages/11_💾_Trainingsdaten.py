...
if(option == 'Epoche 10'):
    ...
    st.image("Trainingsbilder/Elefanten/70 Epochen Elefant.png",  width=breite)
     ...
     st.image("Trainingsbilder/Pferde/Pferde_Loss_Plot.jpg", width=int((breite/2)))
     st.image("Trainingsbilder/Elefanten/Verlustdiagramm 70 Epochen.png", width=int((breite/2)))
