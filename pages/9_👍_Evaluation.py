...
with col1:
    st.image("Trainingsbilder/Pferde/Pferde_Loss_Plot.jpg", caption= 'Verlustgrafik der Pferde', width=360)
with col2:
    st.image("Trainingsbilder/Elefanten/Verlustdiagramm 70 Epochen.png", caption = 'Verlustgrafik der Elefanten', width=360)
with col3:
    st.image("Trainingsbilder/Human/Verlust Menschen.jpg", caption = 'Verlustgrafik der Ansammlung', width=360)
